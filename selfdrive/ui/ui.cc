...
void ui_init(UIState *s) {
  ...
  s->nOpkrUIBrightness = params.getBool("OpkrUIBrightness");
  s->nOpkrUIVolumeBoost = params.getBool("OpkrUIVolumeBoost");
  ...
  s->lat_control = params.getBool("LateralControlMethod");
  s->driving_record = params.getBool("OpkrDrivingRecord");
  s->speed_lim_off = params.getBool("OpkrSpeedLimitOffset");
  s->scene.laneless_mode = params.getBool("LanelessMode");
