...
void ui_init(UIState *s) {
  ...
  s->nOpkrUIBrightness = params.get<int>("OpkrUIBrightness");
  s->nOpkrUIVolumeBoost = params.get<int>("OpkrUIVolumeBoost");
  ...
  s->lat_control = params.get<int>("LateralControlMethod");
  s->driving_record = params.getBool("OpkrDrivingRecord");
  s->speed_lim_off = params.get<float>("OpkrSpeedLimitOffset");
  s->scene.laneless_mode = params.get<int>("LanelessMode");
